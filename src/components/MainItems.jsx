  ...
  return (
    <div>
      ...
      <div>
        ...
        <div>
          <span>
            COOL하게 여름나기!<em>하와이안 라춘과 더위탈출</em>
          </span>
        </div>
        ...
        <div>
          <ul>
            <li>
              <div>
                <a href="/products/8721">
                  <img
                    src="https://img1.kakaocdn.net/thumb/R68x68@2x.q82.fwebp/?fname=https%3A%2F%2Ft1.kakaocdn.net%2Ffriends%2Fprod%2Fproduct%2F20220718180445425_8809814926276_AW_00.jpg"
                    alt="차량용 방향제_바람개비 리틀라이언"
                  />
                  <span>상품 순위</span>
                  <span>1</span>
                  <div>상품명</div>
                  <span>차량용 방향제_바람개비 리틀라이언</span>
                  <span>가격</span>
                  <span>
                    <em>17,000</em>원
                  </span>
            ...
            <li>
              <div>
                <a href="/products/9869">
                  <div>
                    <img
                      src="https://img1.kakaocdn.net/thumb/R68x68@2x.q82.fwebp/?fname=https%3A%2F%2Ft1.kakaocdn.net%2Ffriends%2Fprod%2Fproduct%2F20230518100550957_8809943000199_8809943000199_AW_00.jpg"
                      alt="와다다곰 인형키링 유치원모자"
                    />
                  </div>
                  <span>상품 순위</span>
            ...
            <li>
              <a href="/products/9581">
                <img
                  src="https://img1.kakaocdn.net/thumb/R68x68@2x.q82.fwebp/?fname=https%3A%2F%2Ft1.kakaocdn.net%2Ffriends%2Fprod%2Fproduct%2F20230310154556253_8809922501532_AW_00.jpg"
                  alt="바람개비 방향제_춘식이"
                />
                <span>상품 순위</span>
                <span>3</span>
      ...
      <div>
        ...
        <div>
          <span>영상 타이틀</span>
          <strong>일상에 포인트를 더하다</strong>
          <span>영상 설명</span>
          <span>시선을 사로잡는 체커보드 인테리어</span>
        </div>
      </div>
      <hr/>
      <hr/>
